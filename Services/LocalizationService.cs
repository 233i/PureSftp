    ...
    private static readonly IReadOnlyDictionary<AppLanguage, IReadOnlyDictionary<string, string>> Resources =
        new Dictionary<AppLanguage, IReadOnlyDictionary<string, string>>
        {
            [AppLanguage.English] = new Dictionary<string, string>
            {
                ...
                ["EditConnectionDescription"] = "Update this server profile and test it before saving.",
                ["EditConnectionButton"] = "Edit",
                ["DeleteConnectionButton"] = "Delete",
                ["ConnectionNameLabel"] = "Name",
                ["TestConnectionButton"] = "Test",
                ["SaveConnectionButton"] = "Save",
                ["UpdateConnectionButton"] = "Update",
                ...
                ["ShowHiddenItemsLabel"] = "Hidden",
                ["ActivityTitle"] = "Activity",
                ["SettingsTitle"] = "Settings",
                ["SettingsDescription"] = "Switch the interface language and appearance here. Preferences are stored locally and restored on the next launch.",
                ["LanguageTitle"] = "Language",
                ["LanguageDescription"] = "Choose the display language for the application.",
                ["LanguageLabel"] = "Display language",
                ["LanguagePreviewLabel"] = "Current language",
                ["ThemeTitle"] = "Theme",
                ["ThemeDescription"] = "Choose light, dark, or follow the system appearance.",
                ["ThemeLabel"] = "Appearance",
                ["ThemePreviewLabel"] = "Current theme",
                ["ThemeSystemOption"] = "Follow system",
                ["ThemeLightOption"] = "Light",
                ["ThemeDarkOption"] = "Dark",
                ["ThemeCustomOption"] = "Custom gradient",
                ["CustomGradientStartLabel"] = "Gradient start",
                ["CustomGradientEndLabel"] = "Gradient end",
                ["CustomGradientHint"] = "Use HEX colors, for example #0F172A and #2563EB.",
                ...
                ["NoActiveConnectionTitle"] = "No active connection",
                ["BrowserOfflineHint"] = "Open a saved connection or create a new one to browse remote files.",
                ["BrowserEmptyHint"] = "This remote directory is empty.",
                ...
                ["SelectionSummaryMany"] = "{0} items selected.",
                ...
                ["StatusConnectionSaved"] = "Saved connection {0}.",
                ["StatusConnectionUpdated"] = "Updated connection {0}.",
                ["StatusConnectionDeleted"] = "Deleted connection {0}.",
                ...
                ["StatusUploadingBatch"] = "Uploading {0} item(s)...",
                ["StatusUploaded"] = "Uploaded {0}.",
                ["StatusUploadedBatch"] = "Uploaded {0} item(s).",
                ["StatusUploadingFolder"] = "Uploading folder {0}...",
                ["StatusUploadedFolder"] = "Uploaded folder {0}.",
                ["StatusUploadFailed"] = "Upload failed: {0}",
                ["StatusNoUploadableItems"] = "No valid local item to upload.",
                ...
                ["StatusDownloadingBatch"] = "Downloading {0} item(s)...",
                ["StatusDownloadedFolder"] = "Downloaded folder {0}.",
                ["StatusDownloadedFile"] = "Downloaded {0}.",
                ["StatusDownloadedBatch"] = "Downloaded {0} item(s).",
                ["StatusDownloadFailed"] = "Download failed: {0}",
                ["ToastDownloadSuccess"] = "Download succeeded.",
                ["StatusDeleting"] = "Deleting {0}...",
                ["StatusDeleted"] = "Deleted {0}.",
                ["StatusDeletingBatch"] = "Deleting {0} item(s)...",
                ["StatusDeletedBatch"] = "Deleted {0} item(s).",
                ["StatusDeleteFailed"] = "Delete failed: {0}",
                ["StatusCreatingFolder"] = "Creating {0}...",
                ["StatusCreatedFolder"] = "Created folder {0}.",
                ["StatusRenaming"] = "Renaming {0}...",
                ["StatusRenamed"] = "Renamed {0} to {1}.",
                ["StatusRenameCancelled"] = "Rename cancelled.",
                ["StatusRenameFailed"] = "Rename failed: {0}",
                ["StatusRemoteNameExists"] = "A remote item named {0} already exists.",
                ["StatusChangingPermissions"] = "Changing permissions for {0}...",
                ["StatusChangedPermissions"] = "Changed {0} permissions to {1}.",
                ["StatusChangePermissionsFailed"] = "Permission change failed: {0}",
                ["StatusInvalidName"] = "Names cannot contain path separators.",
                ["StatusInvalidPermissions"] = "Enter an octal permission such as 644 or 755.",
                ["StatusLanguageChanged"] = "Language switched to {0}.",
                ["OverwriteTitle"] = "Item already exists",
                ["OverwriteRemoteMessage"] = "A remote item already exists at:\n{0}\n\nDo you want to overwrite it?",
                ["OverwriteLocalMessage"] = "A local item already exists at:\n{0}\n\nDo you want to overwrite it?",
                ["DeleteConfirmTitle"] = "Delete selected items?",
                ["DeleteConfirmMessage"] = "This will delete {0} selected item(s) from the server.",
                ["DeleteConfirmButton"] = "Delete",
                ["RenamePlaceholder"] = "New name",
                ["ChmodPlaceholder"] = "Octal mode, for example 755",
            ...
            [AppLanguage.ChineseSimplified] = new Dictionary<string, string>
            {
                ...
                ["EditConnectionDescription"] = "更新这个服务器配置，保存前也可以先测试。",
                ["EditConnectionButton"] = "编辑",
                ["DeleteConnectionButton"] = "删除",
                ["ConnectionNameLabel"] = "名称",
                ["TestConnectionButton"] = "测试",
                ["SaveConnectionButton"] = "保存",
                ["UpdateConnectionButton"] = "更新",
                ...
                ["ShowHiddenItemsLabel"] = "隐藏文件",
                ["ActivityTitle"] = "活动记录",
                ["SettingsTitle"] = "设置",
                ["SettingsDescription"] = "你可以在这里切换界面语言和外观。设置会保存在本地，下次启动时自动恢复。",
                ["LanguageTitle"] = "语言",
                ["LanguageDescription"] = "选择应用界面的显示语言。",
                ["LanguageLabel"] = "显示语言",
                ["LanguagePreviewLabel"] = "当前语言",
                ["ThemeTitle"] = "主题",
                ["ThemeDescription"] = "选择浅色、深色，或跟随系统外观。",
                ["ThemeLabel"] = "外观",
                ["ThemePreviewLabel"] = "当前主题",
                ["ThemeSystemOption"] = "跟随系统",
                ["ThemeLightOption"] = "浅色",
                ["ThemeDarkOption"] = "深色",
                ["ThemeCustomOption"] = "自定义渐变",
                ["CustomGradientStartLabel"] = "渐变起始色",
                ["CustomGradientEndLabel"] = "渐变结束色",
                ["CustomGradientHint"] = "使用 HEX 颜色，例如 #0F172A 和 #2563EB。",
                ["AppInfoTitle"] = "关于 PureSftp",
                ["AppInfoDescription"] = "PureSftp 专注于轻量级远程文件操作，用简洁的 Avalonia 桌面体验覆盖多个平台。",
                ["StateWorking"] = "处理中",
                ["StateConnected"] = "已连接",
                ["StateOffline"] = "未连接",
                ["NoActiveConnectionTitle"] = "暂无活动连接",
                ["BrowserOfflineHint"] = "打开已保存连接，或创建新连接后开始浏览远程文件。",
                ["BrowserEmptyHint"] = "当前远程目录为空。",
                ["ConnectionSummaryOffline"] = "一个轻量、跨平台、专注快速文件操作的 SFTP 工具。",
                ["ConnectionSummaryOnline"] = "{0}:{1}，用户 {2}",
                ["SelectionSummaryNone"] = "当前未选择任何项。",
                ["SelectionSummaryItem"] = "{0} · {1}",
                ["SelectionSummaryMany"] = "已选择 {0} 项。",
                ...
                ["StatusConnectionSaved"] = "已保存连接 {0}。",
                ["StatusConnectionUpdated"] = "已更新连接 {0}。",
                ["StatusConnectionDeleted"] = "已删除连接 {0}。",
                ...
                ["StatusUploadingBatch"] = "正在上传 {0} 项...",
                ["StatusUploaded"] = "已上传 {0}。",
                ["StatusUploadedBatch"] = "已上传 {0} 项。",
                ["StatusUploadingFolder"] = "正在上传文件夹 {0}...",
                ["StatusUploadedFolder"] = "已上传文件夹 {0}。",
                ["StatusUploadFailed"] = "上传失败：{0}",
                ["StatusNoUploadableItems"] = "没有可上传的有效本地项目。",
                ["ToastUploadSuccess"] = "上传成功。",
                ["StatusDownloadCancelled"] = "已取消下载。",
                ["StatusPreparingDownload"] = "正在准备下载...",
                ["StatusDownloading"] = "正在下载 {0}...",
                ["StatusDownloadingBatch"] = "正在下载 {0} 项...",
                ["StatusDownloadedFolder"] = "已下载文件夹 {0}。",
                ["StatusDownloadedFile"] = "已下载 {0}。",
                ["StatusDownloadedBatch"] = "已下载 {0} 项。",
                ["StatusDownloadFailed"] = "下载失败：{0}",
                ["ToastDownloadSuccess"] = "下载成功。",
                ["StatusDeleting"] = "正在删除 {0}...",
                ["StatusDeleted"] = "已删除 {0}。",
                ["StatusDeletingBatch"] = "正在删除 {0} 项...",
                ["StatusDeletedBatch"] = "已删除 {0} 项。",
                ["StatusDeleteFailed"] = "删除失败：{0}",
                ["StatusCreatingFolder"] = "正在创建 {0}...",
                ["StatusCreatedFolder"] = "已创建文件夹 {0}。",
                ["StatusRenaming"] = "正在重命名 {0}...",
                ["StatusRenamed"] = "已将 {0} 重命名为 {1}。",
                ["StatusRenameCancelled"] = "已取消重命名。",
                ["StatusRenameFailed"] = "重命名失败：{0}",
                ["StatusRemoteNameExists"] = "远程目录中已存在名为 {0} 的项目。",
                ["StatusChangingPermissions"] = "正在修改 {0} 的权限...",
                ["StatusChangedPermissions"] = "已将 {0} 的权限改为 {1}。",
                ["StatusChangePermissionsFailed"] = "权限修改失败：{0}",
                ["StatusInvalidName"] = "名称不能包含路径分隔符。",
                ["StatusInvalidPermissions"] = "请输入八进制权限，例如 644 或 755。",
                ["StatusLanguageChanged"] = "界面语言已切换为 {0}。",
                ["OverwriteTitle"] = "项目已存在",
                ["OverwriteRemoteMessage"] = "远程位置已经存在同名项目：\n{0}\n\n是否覆盖？",
                ["OverwriteLocalMessage"] = "本地位置已经存在同名项目：\n{0}\n\n是否覆盖？",
                ["DeleteConfirmTitle"] = "删除所选项目？",
                ["DeleteConfirmMessage"] = "将从服务器删除已选择的 {0} 个项目。",
                ["DeleteConfirmButton"] = "删除",
                ["RenamePlaceholder"] = "新名称",
                ["ChmodPlaceholder"] = "八进制权限，例如 755",
